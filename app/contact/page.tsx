...
/**
 * Rendered per request so each visitor gets a freshly signed form token. A
 * prerendered page would hand everyone the same token, minted at build time
 * and already expired.
 */
export const dynamic = "force-dynamic";

/** Server actions POST to the page's own path. */
const PROTECTED = [{ path: "/contact", method: "POST" }];
