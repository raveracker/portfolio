...
/**
 * lucide dropped its brand marks, so GitHub, LinkedIn and Instagram are
 * inline paths (simple-icons, 24x24). They are decoration - the accessible
 * name lives on the anchor that wraps them.
 */
