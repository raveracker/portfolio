...
interface DockItemData {
  ...
  /** Render as a real link instead of a button. Preferred for navigation. */
  href?: string;
...
function DockItem({
  ...
  const content = (
    <>
      ...
      >
        {/* Icon */}
        <div className="w-[60%] h-[60%] flex items-center justify-center text-foreground">
          {item.icon}
        </div>
...
function MagneticDock({
  ...
  const variantStyles = {
    ...
    solid: cn("bg-surface", "border border-hairline"),
